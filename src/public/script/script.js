...
function clickedLight(){
  ...
  let contactSlider__two = document.querySelector('.contactSlider__two');
  contactSlider__two.style.display ='none';
  let subscribePage = document.querySelector('.subscribePage');
  subscribePage.style.opacity = '0';
  
  let contactSlider = document.querySelector('.contactSlider');
  let contactPage = document.querySelector('.contactPage');
  
  
  let sub__btn = document.querySelector('.sub__btn');
  sub__btn.addEventListener('click', function(){
    subscribePage.style.opacity= '1';
    contactPage.style.opacity = '0';
    contactSlider__two.style.display = 'block';
    contactSlider.style.display = 'none';
  });
  
  let cont__btn = document.querySelector('.cont__btn');
  cont__btn.addEventListener('click', function(){
